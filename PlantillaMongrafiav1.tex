...
%\usepackage{helvet}
%\linespread{2}                                  % Fuente Palatino necesita espaciado
\usepackage[full]{textcomp}                        % Caracteres especiales como ' (recto)
\usepackage{xcolor}                                % Color: X11names (en el documentclass)
\usepackage{setspace}%espaciado \doublespace %para doble espacio, \onehalfspace %para espacio y medio,\singlespace %para retornar al espacio sencillo
...
\fi
\graphicspath{ {./imagen/} } % Ruta respecto al fichero tex principal dónde se buscan imágenes
%>>>>>>>>>>>>>>>>>>>>>fininserciondeimagenes---------------------------------------------------------------------------------
...
%----------------------------------------------------------------------------------------
\usepackage{fancyhdr}
% Números de página en rectángulos y capítulo. Necesitamos posicionar los nodos(mover la posición de l cuadradito)
\usepackage[absolute]{textpos}
    \setlength{\TPHorizModule}{9.71mm}% 1 generic horizontal unit is equivalent to 10mm
    \setlength{\TPVertModule}{7.5mm}% 1 generic vertical unit is equivalent to 10mm
...
%L=Left, Odd Even - Decoración en encabezado aqui entra el encabezado verde con titulo de ref http
\fancyhead[LO,LE]{}
